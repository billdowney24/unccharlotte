 ...
 *
 *   1. Add all the properties your Student class will need. You're free to make
 ...
 *         public Student () { }
 *
 *      You can make your attributes either `private` or `public`. If you make
 ...
 *      class, so you'll have one line in your previously empty constructor!
 *
